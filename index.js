...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`star Bot- Script By : n3k4a `);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers ' Script By : MarkingBot Codes ' `);
    console.log(`----------------`);
...
const developers = ["457526495666110485"]
...
client.channels.find('id', '528247290385661952').setName("Welcome To M");
client.channels.find('id', '528247290385661952').setName("Welcome To Ma");
client.channels.find('id', '528247290385661952').setName("Welcome To Mar");
client.channels.find('id', '528247290385661952').setName("Welcome To Mark");
client.channels.find('id', '528247290385661952').setName("Welcome To Marki");
client.channels.find('id', '528247290385661952').setName("Welcome To Markin");
client.channels.find('id', '528247290385661952').setName("Welcome To Marking");
client.channels.find('id', '528247290385661952').setName("Welcome To Marking C");
client.channels.find('id', '528247290385661952').setName("Welcome To Marking Co");
client.channels.find('id', '528247290385661952').setName("Welcome To Marking Code");
client.channels.find('id', '528247290385661952').setName("Welcome To Marking Codes");
  }, 4000);
});
...
client.on("message", message => {    
   ...
   .setColor('RANDOM')
  .setTimestamp()
      .addField(':crown:**__<@4457526495666110485>__**',`**${msg.guild.owner}**`,true)
...
client.on ("guildMemberAdd", member => {
   ...
   var role = member.guild.roles.find ("name", "• MarkingBot » Member");
   member.addRole (role);
              ...
              m.channel.awaitMessages( m1 => m1.author == message.author,{ maxMatches: 1, time: 60*1000 } ).then ( (m1) => {
                  ...
                  m.edit(message.member + ', **:timer:**').then( (m) =>{
                      ...
                      m.edit(message.member + ', **....جارى جمع البيانات**').then( (mtime)=>{
                        ...
                        .addField('**`هما هي لغه البرمجة الخاصه به ؟ `**',`${ask}`)  
...
if(!aUser) return msg.channel.send("Couldn't find users.");
    ...
    ac.send(`** [ @• MarkingBot » Support  ]تم بنجاح قبولك  واعطائك رتبة ${aUser}**`)
    ...
    if(!role) return msg.guild.channel.send("Could't find `• MarkingBot » Support` role.");
    aUser.addRole(role);
    aUser.addRole(role2);
    aUser.addRole(role3);
...
if(!aUser) return msg.channel.send("Couldn't find users.");
    ...
    var role = msg.guild.roles.find(`name`, '• MarkingBot » Support');
    var role2 = msg.guild.roles.find(`name`, '• Help » Github');
    var role3 = msg.guild.roles.find(`name`, '• Help » Heroku');
    if(!role) return msg.guild.channel.send("Could't find `• MarkingBot » Support` role.");
